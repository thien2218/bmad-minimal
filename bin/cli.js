...
program
  .name('bmad-minimal')
  .description('CLI tool to set up and manage BMAD minimal workspace for AI-assisted development')
...
program
  ...
  .argument('[target-directory]', 'Directory where to create the bmad-minimal workspace', '.')
  .option('-y, --yes', 'Skip interactive prompts and use defaults')
  .action(async (targetDirectory, options) => {
    try {
      console.log(chalk.cyan.bold('🚀 BMAD Minimal Installation'));
      console.log(chalk.gray('Setting up your AI-assisted development workspace...\n'));
      ...
      console.log(chalk.gray('Your workspace is ready for AI-assisted development.'));
...
program
  ...
  .argument('[workspace-directory]', 'Directory containing the bmad-minimal workspace', 'bmad-minimal')
  ...
  .action(async (workspaceDirectory, options) => {
    try {
      ...
      console.log(chalk.gray('Updating your workspace to the latest version...\n'));
