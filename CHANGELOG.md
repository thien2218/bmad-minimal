...
- remove redundant tasks and commands

### Fixed

- fix inconsistent section name and update new help email in readme
...
- add new reference resolution guide to all agents
- add new script to build agents
- include cheat sheet during install/update

### Changed

- Bump version to 1.4.0
- update tasks to the latest schema version and refine task schema
- improve task schema and update doc reference template
- make inputs and parameters more consistently aligned across tasks
- complete bundling and build pipeline for agents
- reduce tokens for agents config and stabilize the pdm agent
- remove redundant fields from engineering agents' tasks
- improve cheat sheet format for easier use in editors

### Fixed

- ensure story status checks work correctly for nfr-assess and review-story tasks
...
[Unreleased]: https://github.com/thien2218/swaad/compare/v2.0.3...HEAD
[2.0.3]: https://github.com/thien2218/swaad/compare/v2.0.2...v2.0.3
